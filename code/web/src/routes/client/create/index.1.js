...
const Create = ({
  ...
  const handleInputConfirm = () => {
    if(inputValue && tags.indexOf(inputValue) === -2){
  ...
  return (
    <div className="content-inner">
      <Form>
        <label style={{background:"red", color:"white", padding:"6px 20px", marginLeft: "20px", borderRadius: "3px", zIndex: "500"}}>基础信息</label>
        <Row gutter={8} style={{border: '1px solid red', paddingTop: '20px', marginTop: "-10px", borderRadius: "5px"}}>
          <Col span={7}>
            <FormItem
              {...formItemLayout}
              label="*客户编号"
        ...
        <div style={{marginTop: "20px"}}>
          <label style={{background:"red", color:"white", width: "200px", padding:"6px 20px", marginLeft: "20px", borderRadius: "3px", zIndex: "500"}}>主信息</label>
          <Row gutter={8} style={{border: '1px solid red', paddingTop: '20px', marginTop: "-10px", borderRadius: "5px"}}>
            <Col span={12}>
              <FormItem
                {...formItemLayout}
        ...
        <div style={{marginTop: "20px"}}>
          <label style={{background:"red", color:"white", padding:"6px 20px", marginLeft: "20px", borderRadius: "3px", zIndex: "500"}}>控制信息</label>
          <Row gutter={8} style={{border: '1px solid red', paddingTop: '20px', marginTop: "-10px", borderRadius: "5px"}}>
            <Col span={12}>
              <FormItem
                {...formItemLayout}
